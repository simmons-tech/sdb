...
const UserGuestListPage = (props) => {
    ...
    useEffect(() => {
        ...
        // Get the guests
        axios.get(`/api/users/${props.user.pk}/guest_list/`).then((res) => {
    ...
    return (
        <BasePage loading={loading}>
            ...
            <h2>Guest List</h2>
            <p>
                This is your portion of the Simmons Hall electronic guest list.
                Your visitors do <u>not</u> have to be on this list in order to
                visit. Your entries here serve only as a convenience to you and
                to the desk workers. They can use this system to verify visitors
                without having to call you down to desk.
            </p>
            <p>
                To add a person to your guest list, type his or her full name as
                it would appear on an ID card, but with last name first (e.g.
                "Holl, Simon"). Then click <b>Add</b>.
            </p>
            <Formik
            ...
            <p>
                Any Simmons resident can provide a single use guest list for a
                large event. This guest list can be created no more than one
                week in advance and can be valid for no longer than 24 hours.
            </p>
                ...
                <div key={event.name} className="card mb-3">
                    <div className="card-body">
                        ...
                        <Formik
                            initialValues={{ firstName: "", lastName: "" }}
                            onSubmit={(values) =>
                                onEventGuestListSubmit(values, event)
                            }
                        >
                            <Form>
                                <StripedTable
